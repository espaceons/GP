    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telephone', models.CharField(blank=True, help_text="Numéro de téléphone de l'utilisateur.", max_length=15, null=True)),
                ('adresse', models.CharField(blank=True, help_text="Adresse de l'utilisateur.", max_length=255, null=True)),
